...
- TotemAutomata、TotemLocksmith、TotemNexus、TotemRemnant、TotemVanillaTweaks、TotemVillagers：`>=0.7.12 <0.8.0`
- TotemDiscordBridge、TotemEnchanting、TotemExcavation：`>=0.7.0 <0.8.0`
